...
if __name__ == '__main__':
    ...
    a = Crossword(10, 10, '*', 5000, word_list, extra_words=extra_word_list, letters=heb_letters, rtl=True)
    a.compute_crossword(time_permitted=5.00, spins=2)
